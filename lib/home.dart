...
final Color themeColor = Color.fromARGB(255, 129, 196, 179);
  ...
  List<Widget> _buildActions() {
    return <Widget>[
      ...
      MaterialButton(
        ...
        onPressed: () {
          html.window.open("jeanblakejaque@gmail.com", "Email");
        },
      ),
    ];
  }
...
//        _buildNavigationArrows(),
  ...
  Widget _buildEducationSummary() {
    return Text(
      'I want to inspire others to achieve great things in their career or life path whether it be with the aid of technology or not. I aspire to reach a level of software development where I can influence or create new technologies to break boundaries and help people worldwide, in whichever manner that may be.',
      style: TextStyles.body,
    );
  }
    ...
    return Row(
      ...
      children: <Widget>[
        GestureDetector(
          onTap: () {
            html.window
                .open("https://www.linkedin.com/in/jean-jaque-stellenboom-753771199/", "LinkedIn");
          },
          child: Image.network(
            Assets.linkedin,
            color: Color(0xFF45405B),
        ...
        GestureDetector(
          onTap: () {
            html.window.open("https://github.com/jstellen", "Github");
          },
          child: Image.network(
            Assets.github,
            color: Color(0xFF45405B),
